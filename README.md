...
```
cd existing_repo
git remote add origin https://git.aimotive.com/AI/nnef-to-tvm-converter.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.aimotive.com/AI/nnef-to-tvm-converter/-/settings/integrations)
