...
def test_cts_deconv3x3(target, dev):
    verify_model("deconv3x3", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_conv4x4_stride2x2(target, dev):
    verify_model("conv4x4_stride2x2", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv3x3_pad1_0(target, dev):
    verify_model("deconv3x3_pad1-0", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv2x2(target, dev):
    verify_model("deconv2x2", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv3x3_valid(target, dev):
    verify_model("deconv3x3_valid", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv3x3_pad0_0(target, dev):
    verify_model("deconv3x3_pad0-0", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv3x3_stride2x2(target, dev):
    verify_model("deconv3x3_stride2x2", target, dev, rtol=1e-5, atol=5e-3)
...
def test_cts_deconv3x3_pad0_1(target, dev):
    verify_model("deconv3x3_pad0-1", target, dev, rtol=1e-5, atol=5e-3)
